...
class MedicionLiquidosRefWidget extends StatefulWidget {
  const MedicionLiquidosRefWidget({
    Key key,
    this.recordatorio,
  }) : super(key: key);
  ...
  @override
  _MedicionLiquidosRefWidgetState createState() =>
      _MedicionLiquidosRefWidgetState();
}
