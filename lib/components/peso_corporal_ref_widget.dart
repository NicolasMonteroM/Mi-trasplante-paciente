...
class PesoCorporalRefWidget extends StatefulWidget {
  const PesoCorporalRefWidget({
    Key key,
    this.recordatorio,
  }) : super(key: key);
  ...
  @override
  _PesoCorporalRefWidgetState createState() => _PesoCorporalRefWidgetState();
}

class _PesoCorporalRefWidgetState extends State<PesoCorporalRefWidget> {
